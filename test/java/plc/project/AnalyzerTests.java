...
public final class AnalyzerTests {
    ...
    @MethodSource
    void testSource(String test, Ast.Source ast, Ast.Source expected) {
    ...
    private static Stream<Arguments> testSource() {
        return Stream.of(
                Arguments.of("Hello, World!",
                        ...
                        new Ast.Source(
                                Arrays.asList(),
                                Arrays.asList(init(new Ast.Method("main", Arrays.asList(), Arrays.asList(), Optional.empty(), Arrays.asList(
